...
public class ShipperService {
    ...
    public Shipper getById(Long id) {
        return shipperRepository.findById(id).orElseThrow(() -> new RuntimeException("User not found with ID: " + id));
    }
    ...
    public List<Shipper> findActiveShippers() {
        return shipperRepository.findByStatus("active");
    }
}
